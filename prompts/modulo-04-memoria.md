...
8. **Configure dreaming (experimental, opt-in)** â€” consolidaÃ§Ã£o automÃ¡tica de memÃ³ria enquanto o agente estÃ¡ ocioso:
   ...
   - Depois de cada ciclo, escreve um **Dream Diary** em `DREAMS.md` â€” vocÃª pode ler o que o agente estÃ¡ processando
   - Para ativar: use `/dreaming` na sessÃ£o (ou `/dreaming --dry-run` para ver o que faria sem executar)
   - Isso Ã© diferente da memÃ³ria ativa â€” Ã© uma camada de promoÃ§Ã£o automÃ¡tica que roda em background
